...
const yearsData = [
  ...
  { num: 5, title: "Tamagotchi Virtual", cat: "gaming-sim", path: "#", ready: true, desc: "Mascota virtual retro interactiva para cuidar en el navegador." },
  { num: 6, title: "Hanzi Flashcards & Guochao", cat: "culture-fandom", path: "#", ready: true, desc: "Flashcards interactivas de caracteres chinos con estética tradicional-moderna." },
  { num: 7, title: "Terminal OSINT Simulación", cat: "code-math", path: "#", ready: true, desc: "Juego de investigación en terminal cyberpunk e ingreso de comandos." },
